...
function onCreate()
    ...
    if not lowQuality and songName == 'Censory Superload' then
...
function onSongStart()
    if songName == 'Extermination, Extermination-duet' then
        objectPlayAnimation('qt_tv01', 'instructions', true)
    end
end

function onUpdate(elapsed)
    if songName == 'Censory Superload' then
        if curBeat >= 8 then
    ...
    elseif songName == 'Extermination, Extermination-duet' then
