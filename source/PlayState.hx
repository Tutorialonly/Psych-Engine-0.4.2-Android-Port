...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['SUPER NOOB 100%', 0.4], //From 20% to 39%
		['very very very noob', 0.5], //From 40% to 49%
		['Very noob, 0.6], //From 50% to 59%
		['Noob', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['Not bad', 0.8], //From 70% to 79%
		['umm.its ok', 0.9], //From 80% to 89%
		['Pro', 1], //From 90% to 99%
		['HACKER!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
